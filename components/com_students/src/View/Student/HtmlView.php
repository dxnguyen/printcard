...
namespace Student\Component\Students\Site\View\Student;
// No direct access
	...
	protected function _prepareDocument()
	{
		...
		if ($this->params->get('robots'))
		{
            ...
            $pathway = $app->getPathway();
                        $breadcrumbList = Text::_('COM_STUDENTS_TITLE_STUDENTS');
            
                        if(!in_array($breadcrumbList, $pathway->getPathwayNames())) {
                            $pathway->addItem($breadcrumbList, "index.php?option=com_students&view=students");
                        }
                        $breadcrumbTitle = Text::_('COM_STUDENTS_TITLE_STUDENT');
