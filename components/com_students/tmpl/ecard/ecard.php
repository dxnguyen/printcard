        ...
        <div id="cardBox">
            <div class="controlbox">
                ...
                <!--<p style="text-align: center; margin-bottom: 0;"><span class="control-text">Font-size (Họ tên):</span> <input type="number"
                    ...
                    <button id="exportCard" class="btn btn-sm btn-danger">Tải về</button>
                    <a style="margin-left: 30px;" href="<?php /*echo Route::_('index.php?option=com_students&view=students');*/?>"><button id="" class="btn btn-sm btn-primary"> << Quay lại in thẻ</button></a>
                </p>-->
            </div>
