...
<form
	action="<?php echo Route::_('index.php?option=com_requests&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="request-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="col-md-12 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_REQUESTS_FIELDSET_REQUEST'); ?></legend>
	...
	<?php if (Factory::getApplication()->getIdentity()->authorise('core.admin','requests')) : ?>
