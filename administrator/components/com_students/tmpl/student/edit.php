...
<form
	action="<?php echo Route::_('index.php?option=com_students&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				<legend><?php echo Text::_('COM_STUDENTS_FIELDSET_STUDENT'); ?></legend>
	...
	<?php if (Factory::getApplication()->getIdentity()->authorise('core.admin','students')) : ?>
